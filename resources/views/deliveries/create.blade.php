...
<div class="py-4 animate-fade-in">
    <div class="content-card">
        <div class="card-header-modern">
            ...
            <h4>Nouvelle Livraison</h4>
            <p class="text-white-50 mb-0 mt-2">Planifier une nouvelle livraison de marchandise</p>
        </div>
        
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('deliveries.store') }}" method="POST" class="form-modern">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="destination" class="form-control @error('destination') is-invalid @enderror" value="{{ old('destination') }}" placeholder="ex: Casablanca, Maroc">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" name="date_depart" class="form-control @error('date_depart') is-invalid @enderror" value="{{ old('date_depart', date('Y-m-d')) }}">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" name="date_arrivee" class="form-control @error('date_arrivee') is-invalid @enderror" value="{{ old('date_arrivee') }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror">
                        ...
                        <option value="livree" {{ old('status') == 'livree' ? 'selected' : '' }}>Livrée</option>
