...
<div class="py-4 animate-fade-in">
    <div class="content-card">
        <div class="card-header-modern">
            ...
            <h4>Nouveau plein de carburant</h4>
            <p class="text-white-50 mb-0 mt-2">Enregistrer une nouvelle consommation</p>
        </div>
        
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('fuels.store') }}" method="POST" class="form-modern">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" name="quantity" step="0.1" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity') }}" placeholder="Ex: 50.0">
                        @error('quantity') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6 mb-4">
                        <label class="form-label"><i class="bi bi-cash me-1"></i> Coût total (MAD)</label>
                        <input type="number" name="cost" step="0.01" class="form-control @error('cost') is-invalid @enderror" value="{{ old('cost') }}" placeholder="Ex: 650.00">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="station" class="form-control @error('station') is-invalid @enderror" value="{{ old('station') }}" placeholder="Ex: Afriquia, Shell...">
