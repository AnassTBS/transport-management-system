...
<div class="py-4 animate-fade-in">
    <div class="content-card">
        <div class="card-header-modern">
            ...
            <h4>Modifier le Chauffeur</h4>
            <p class="text-white-50 mb-0 mt-2">Nom: <strong>{{ $driver->nom }}</strong></p>
        </div>
        
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('drivers.update', $driver) }}" method="POST" class="form-modern">
                @csrf
                @method('PUT')

                <div class="mb-4">
                    <label class="form-label"><i class="bi bi-person me-1"></i> Nom complet</label>
                    <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom', $driver->nom) }}">
                    @error('nom') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="mb-4">
                    <label class="form-label"><i class="bi bi-telephone me-1"></i> Téléphone</label>
                    <input type="text" name="tel" class="form-control @error('tel') is-invalid @enderror" value="{{ old('tel', $driver->tel) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="permis" class="form-control @error('permis') is-invalid @enderror" value="{{ old('permis', $driver->permis) }}">
